  ...
  const stats = [
    {
      ...
      description: "Next.js sites load over 50% faster than traditional websites, improving user experience."
    },
    {
      icon: <DollarSign className="w-6 h-6 text-green-600" />,
      value: "Up to 3x",
      label: "Better Organic Rankings",
      description: "SEO-optimized Next.js websites help your business rank higher on Google."
    }
  ];
          ...
          <div className="w-full h-auto lg:w-1/2 flex justify-start items-start relative order-1 lg:order-2">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-full">
              <Image 
                ...
                alt="Performance and SEO Dashboard" 
                width={600}
                height={700}
