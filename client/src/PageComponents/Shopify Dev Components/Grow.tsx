...
const GrowWithShopify: React.FC = () => {
  return (
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg">
              <Image
                ...
                alt="Shopify store growth possibilities"
                width={600}
                height={600}
              ...
              >
                <Image
                  ...
                  alt="Hand pointing to growth opportunities"
                  width={200}
                  height={300}
          ...
          <div className="w-full lg:w-3/4 space-y-4 sm:space-y-6">
            <div>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-center lg:text-start text-blue-200 font-medium">
                From multi-channel selling to AI-powered insights—scale your e-commerce business effortlessly.
              </p>
            </div>

            <p className="text-sm sm:text-base lg:text-xl text-white leading-relaxed text-center lg:text-left">
              Shopify gives you everything you need to grow your online store and increase revenue. Sell across multiple channels including Instagram, Facebook, TikTok, Amazon, eBay, and Google Shopping—all managed from one dashboard. Research shows adding just one sales channel increases revenue by 38%, with each additional channel boosting growth by 120% and 190% respectively. Leverage powerful Shopify Analytics to track conversion rates, customer behavior, sales trends, and inventory management in real-time. Use built-in marketing tools, abandoned cart recovery, loyalty programs, and mobile optimization to turn browsers into buyers and scale your business faster than ever.
            </p>
            ...
            <div className="pt-4 sm:pt-4 lg:pb-4 flex justify-center lg:justify-start">
              <div className="inline-flex items-center px-5 py-2.5 sm:px-6 sm:py-3 lg:px-8 lg:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs sm:text-sm lg:text-base font-semibold rounded-full shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
                <span className="mr-2 sm:mr-3">Start Growing Your Store</span>
...
export default GrowWithShopify
