          ...
          <div className="w-full lg:w-3/4 space-y-4 sm:space-y-6">
            <div>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-center lg:text-start text-blue-500 font-medium">
                Uncover critical issues holding your website back from top rankings and sustainable organic growth.
              </p>
            </div>

            <p className="text-sm sm:text-base lg:text-lg text-gray-900 leading-relaxed text-center lg:text-left">
              An SEO audit is a comprehensive analysis of your website's search performance, technical health, content quality, and visibility barriers. Our expert team systematically examines{' '}
              ...
              {' '}like broken links, crawl errors, slow page speeds (only 12% of sites pass Core Web Vitals), poor mobile optimization, duplicate content, and missing structured data that prevent higher rankings. As the foundation of any{' '}
              ...
              , our free audit delivers a detailed report with prioritized, actionable recommendations to improve search rankings, increase organic traffic, uncover{' '}
              <a href="https://www.vaphers.com/seo-services" className="text-blue-500 underline hover:text-blue-400 duration-200 font-medium">
                keyword opportunities
              </a>
              , and outperform competitors. Don't let hidden issues cost you valuable customers, discover exactly what's holding your website back and get a clear roadmap to measurable SEO success.
            </p>
            ...
            <div className="pt-4 sm:pt-4 lg:pb-4 flex justify-center lg:justify-start">
              <Link href="/contact-us">
                <div className="inline-flex items-center px-5 py-2.5 sm:px-6 sm:py-3 lg:px-8 lg:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs sm:text-sm lg:text-base font-semibold rounded-full shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
                  <span className="mr-2 sm:mr-3">Get Your Free SEO Audit</span>
