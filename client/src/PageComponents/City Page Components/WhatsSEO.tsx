...
interface DMvalueProps {
  cityName: string
}

const WhatsSEO: React.FC<DMvalueProps> = ({ cityName }) => {
          ...
          >
            <div>
              <h3 className="text-3xl md:text-3xl lg:text-5xl text-center lg:text-start font-sans text-gray-700 mb-4 bungee-inline-regular break-words">
                What Even Is
                <span className="bg-blue-600 bg-clip-text text-transparent"> SEO?</span>{' '}
              </h3>
              <p className="text-sm sm:text-base lg:text-lg text-center lg:text-start text-blue-600 font-medium break-words">
                Search Engine Optimization (SEO) is a powerful digital marketing strategy designed to increase your website’s visibility on search engines like Google, driving organic traffic from users actively seeking products or services related to your business in {cityName}.
              </p>
            </div>
            <p className="text-sm sm:text-base lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left break-words">
              By leveraging expert keyword research, on-page and technical SEO, content optimization, and authoritative link-building strategies, SEO helps your {cityName} business rank higher for relevant search queries — such as local SEO, organic search, and digital marketing services — resulting in increased leads and sustained growth.
            </p>
            <p className="text-sm sm:text-base lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left break-words">
              Effective SEO combines local search optimization, competitor analysis, and continuous performance tracking to adapt to changing algorithms and user behavior, ensuring your {cityName} brand stays competitive and visible in front of your ideal customers.
            </p>
