...
interface LeadingAgencyProps {
  cityName: string
}

export default function LeadingAgency({ cityName }: LeadingAgencyProps) {
  return (
    <section className="flex flex-col lg:flex-row items-start justify-between gap-12 px-8 py-16 lg:py-8 lg:pt-8 max-w-7xl mx-auto">
      {/* title */}
      <div className="w-full lg:w-2/5">
        <h4 className="text-4xl lg:text-4xl xl:text-6xl font-bold text-gray-700 leading-tight montserrat">
          {`Leading SEO Agency in ${cityName}`}
        </h4>
