...
const BannerBG =
  'https://res.cloudinary.com/dbwrnwa3l/image/upload/f_auto,q_auto,w_1920/v1761047473/banner-bg_vebtpx.png'

const Banner: React.FC<BannerProps> = ({ cityName }) => {
  return (
    <section
    ...
    >
      <div className="hidden sm:block absolute left-4 sm:left-8 lg:left-[12.5rem] 2xl:left-[15rem] -top-8 sm:-top-12 lg:-top-15 h-[140px] sm:h-[180px] lg:h-[220px] w-auto z-30">
        <Image
      ...
      <div className="sm:hidden relative z-10 h-full flex flex-col items-center justify-center gap-3 px-4">
        <h2 className="text-white text-sm font-bold leading-tight text-center">
          Need SEO Service for growing your Business in {cityName}? Just Call Us.
        </h2>
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="text-center lg:text-center lg:mt-14 max-w-2xl">
            <h2 className="text-white text-base md:text-lg lg:text-2xl font-bold leading-tight">
              ...
              <br />
              Business in <span className="capitalize">{cityName}</span>? Just Call Us.
            </h2>
          </div>
        </div>
