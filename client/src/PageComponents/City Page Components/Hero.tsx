...
function CityHero({ 
  ...
  const heading = `#1 SEO Agency in ${formattedCity}`;
  const subtext = `Transform your business with data-driven SEO strategies. We help ${formattedCity} businesses dominate search rankings and drive real results.`;
  const badgeText = `Trusted by ${formattedCity} businesses`;
  
  return (
    <div className="relative mx-auto flex max-w-full flex-col items-center justify-center bg-gradient-to-b from-[#01091c] via-[#0a244d] to-[#0f3064] lg:-mt-28 lg:pt-40 lg:pb-15 lg:mx-3 lg:rounded-4xl">
