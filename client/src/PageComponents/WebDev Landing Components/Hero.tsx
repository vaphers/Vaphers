...
function WebDevHero() {
  ...
  const headline = "Web Design That Grows Your Business"; // outcome-focused headline
  const subtext =
    "Launch a fast, conversion-focused website with clean UI, SEO-ready architecture, and seamless performance across devices."; // concise value prop
