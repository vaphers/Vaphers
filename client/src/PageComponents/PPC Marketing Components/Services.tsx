...
const PPCMarketingServicesAccordion: React.FC = () => {
  ...
  const services: Service[] = [
    {
      ...
      description:
        'We manage your Google Ads campaigns end-to-end, ensuring maximum ROI through strategic bidding, targeted keyword research, and well-optimized ad copy.',
      points: [
    ...
    },
    {
      ...
      description:
        'Expert management of Facebook and Instagram ads to grow your brand presence, increase conversions, and engage highly segmented audiences.',
      points: [
        'Target audience segmentation',
        'Creative and copywriting assistance',
        'A/B testing for optimal ads',
    ...
    },
    {
      ...
      description:
        'Drive high-quality leads with tailored PPC campaigns focusing on attracting customers ready to convert, backed by data-driven strategy and nurturing tactics.',
      points: [
    ...
    },
    {
      ...
      description:
        'Boost your business visibility on search engines through expertly managed SEM campaigns that combine paid search and organic tactics for best results.',
      points: [
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 sm:mb-12 gap-6">
            <div>
              ...
              <h2 className="text-gray-700 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold uppercase leading-tight bungee-inline-regular">
                Explore Our
                <br />
                <span className="bg-blue-600 bg-clip-text text-transparent">PPC Marketing Services</span>
              </h2>
            </div>
                        ...
                        <div className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8 lg:pb-10 border-t border-gray-200">
                          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center pt-6 sm:pt-8">
                            ...
                            >
                              <Image
                                src={service.image}
                                alt={`${service.title} - PPC marketing service illustration`}
                                fill
...
export default PPCMarketingServicesAccordion
