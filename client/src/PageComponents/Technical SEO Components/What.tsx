...
const WhatsTechnicalSEO: React.FC = () => {
  ...
  return (
    ...
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-10 pb-8 sm:pb-12 lg:pb-10'>
          ...
          <div className="w-full h-auto lg:w-1/2 flex justify-center items-center relative order-1 lg:order-2">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-full">
              <Image 
                ...
                alt="Technical SEO optimization dashboard showing website performance metrics" 
                width={600}
                height={600}
...
export default WhatsTechnicalSEO;
