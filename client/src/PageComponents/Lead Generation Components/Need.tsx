...
const WhyLeadGeneration: React.FC = () => {
  return (
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg">
              <Image
                ...
                alt="Lead generation funnel with conversion stages and customer journey"
                width={600}
                height={600}
              ...
              >
                <Image
                  ...
                  alt="Hand pointing to lead generation funnel"
                  width={200}
                  height={300}
          ...
          <div className="w-full lg:w-3/4 space-y-4 sm:space-y-6">
            <div>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-center lg:text-start text-blue-200 font-medium">
                The Lifeblood of Your Sales Pipeline and Business Growth
              </p>
            </div>

            <p className="text-sm sm:text-base lg:text-xl text-white leading-relaxed text-center lg:text-left">
              Without lead generation, your business is left waiting for customers to find you—and that's simply not enough to sustain growth. Lead generation serves as the{' '}
              <span className="font-bold text-blue-300">lifeblood of your sales funnel</span>, creating a steady stream of qualified prospects who are actively interested in your solutions. In today&apos;s competitive marketplace, businesses with effective lead generation strategies see{' '}
              <a href="#" className="text-blue-200 underline hover:text-blue-400 duration-200 font-medium">
                133% more revenue than those without
              </a>
              . Lead generation builds visibility, establishes trust, shortens sales cycles, and provides invaluable customer insights that help you make data-driven decisions. It&apos;s not just about selling—it&apos;s about building relationships, increasing brand awareness, and creating a sustainable customer base that fuels long-term success.
            </p>
            ...
            <div className="pt-4 sm:pt-4 lg:pb-4 flex justify-center lg:justify-start">
              <div className="inline-flex items-center px-5 py-2.5 sm:px-6 sm:py-3 lg:px-8 lg:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs sm:text-sm lg:text-base font-semibold rounded-full shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
                <span className="mr-2 sm:mr-3">Build Your Lead Pipeline Today</span>
...
export default WhyLeadGeneration
