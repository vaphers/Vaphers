    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-20 pb-8 sm:pb-12 lg:pb-16">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 sm:gap-10 lg:gap-12">
          ...
          <motion.div
            style={{ opacity }}
            className="w-full lg:w-2/3 space-y-8 sm:space-y-10"
          >
            ...
            <div>
              ...
              <p className="text-sm sm:text-base lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left break-words">
                Effective marketing builds visibility, credibility, and demand over time. Instead of relying on short-term
                tactics, a well-executed marketing strategy attracts the right audience, nurtures trust, and turns interest
                into action. The result is sustainable traffic, qualified leads, and steady business growth that continues
                to deliver value long after the initial investment.
              </p>
            </div>
