...
function Hero() {
  const shouldReduceMotion = useReducedMotion(); // ✅ key fix

  return (
    <LazyMotion features={domAnimation}>
      <div className="relative mx-auto mb-10 flex max-w-full flex-col items-center justify-center bg-gradient-to-b from-[#01091c] via-[#0a244d] to-[#0f3064] lg:-mt-28 lg:pt-40 lg:mx-3 lg:rounded-4xl">

        <div className="border border-indigo-600 p-1 w-75 mx-auto rounded-full flex items-center justify-between mb-7 mt-5">
          <span className="font-inter text-base font-medium text-gray-300 ml-3">
            Explore how to use for brands.
          </span>
          <Link
        ...
        <div className="px-4 pb-10 flex flex-col items-center">
          ...
          >
            <Link href="/seo-services" className="w-60">
              <button className="w-full rounded-lg bg-blue-600 px-6 py-2.5 font-medium text-white transition hover:bg-blue-800">
                Explore Now
              </button>
            </Link>

            <Link href="/contact" className="w-60">
              <button className="w-full rounded-lg border border-blue-600 bg-white px-6 py-2.5 font-medium text-blue-600 transition hover:bg-gray-50">
                Contact Support
              </button>
            </Link>
          </m.div>

          {/* 🚀 IMAGE — NO MOTION, FAST LCP */}
          <div className="relative z-10 mt-20 w-full max-w-6xl rounded-3xl border border-neutral-300 bg-neutral-200 p-2 md:p-4 shadow-md">
