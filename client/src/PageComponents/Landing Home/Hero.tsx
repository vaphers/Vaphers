  ...
  return (
    <div className="relative mx-auto mb-10 flex max-w-full flex-col items-center justify-center bg-gradient-to-b from-[#01091c] via-[#0a244d] to-[#0f3064] lg:-mt-28 lg:pt-40 lg:mx-3 lg:rounded-4xl">
      ...
      <div className="px-4 pb-10">
        ...
        {/* Buttons */}
        {/* Mobile: Static buttons - removed hover animations that trigger repaints */}
        <div className="relative z-10 mt-8 flex flex-col items-center justify-center gap-3 md:hidden">
          <Link href="/seo-services" className="w-60">
            <button className="w-full rounded-lg bg-blue-600 px-6 py-2.5 font-medium text-white active:bg-blue-700">
              Explore Now
            </button>
          </Link>
          <Link href="/contact" className="w-60">
            <button className="w-full rounded-lg border border-blue-600 bg-white px-6 py-2.5 font-medium text-blue-600 active:bg-gray-50">
              Contact Support
            </button>
          </Link>
        </div>
        ...
        {/* Image */}
        {/* Mobile: Show optimized static image (no animation wrapper) */}
        <div className="md:hidden relative z-10 mt-20 rounded-3xl border border-neutral-300 bg-neutral-200 p-4 shadow-md dark:border-neutral-800 dark:bg-neutral-900">
          <div className="w-full overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700">
            <Image
              src="https://res.cloudinary.com/dbwrnwa3l/image/upload/f_auto,q_auto:low,c_limit,w_640,dpr_auto/v1761213572/hero_landing_rhywrd.jpg"
              alt="Landing page preview"
              className="aspect-[16/9] h-auto w-full object-cover"
              width={640}
              height={360}
