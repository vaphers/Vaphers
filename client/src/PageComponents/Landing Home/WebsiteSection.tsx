    ...
    <section
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
            ...
            >
                {/* Section 1 */}
                <div>
                <h3 className="text-3xl md:text-4xl lg:text-5xl text-center lg:text-left font-sans text-gray-700 mb-4 bungee-inline-regular">
                    We Design
                ...
                <p className="text-base sm:text-lg lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left">
                    ...
                    , we build fast, scalable, and SEO-friendly platforms while also supporting advanced frameworks through specialized Angular JS SEO strategies that ensure JavaScript-heavy websites remain fully discoverable and optimized for search engines.
                </p>
                </div>
            ...
            >
                ...
                <div className="absolute inset-0 pointer-events-none">
                    ...
                    animate="animate"
                    className="absolute top-4 sm:top-10 right-0 sm:right-4"
                    >
                    <Image
