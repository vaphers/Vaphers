...
export default function EditPostPage() {
  ...
  return (
    // Changed: Applied responsive flex-col to stack items on mobile, and lg:flex-row for side-by-side on desktop
    <div className="flex flex-col lg:flex-row mx-auto w-full min-h-screen pt-4 lg:pt-10 px-4 lg:px-10">
      
      {/* Changed: Added w-full min-w-0 to prevent content from overflowing on small devices */}
      ...
      {/* Sidebar naturally drops below the editor on mobile, sits to the right on lg screens */}
      <Sidebar
        title={title}
