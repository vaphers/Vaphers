...
const tabContents: TabItem[] = [
  {
    ...
    title: 'ChatGPT Visibility Optimization',
    description:
      "ChatGPT prioritizes authoritative, well-structured content for its conversational responses and citations. Our ChatGPT SEO experts optimize your content for semantic relevance, answer extraction, and structured data implementation to ensure your brand dominates ChatGPT's AI-generated answers and appears in critical user queries.",
  },
  {
    id: 'search',
    icon: <Search className="w-8 h-8 text-teal-600" />,
    title: 'ChatGPT Citation Optimization',
    description:
      'Master ChatGPT search with our specialized GEO (Generative Engine Optimization) strategies. We implement ChatGPT-preferred schema markup, create conversational query-optimized content with clear definitions and step-by-step guides, and optimize for ChatGPT\'s unique citation algorithms to get your brand consistently quoted.',
  },
  {
    id: 'refresh',
    icon: <RotateCcw className="w-8 h-8 text-green-600" />,
    title: 'ChatGPT Content Strategy',
    description:
      'Harness content strategies specifically tuned for ChatGPT success. We conduct ChatGPT-focused conversational query research, generate comprehensive Q&A format content, and continuously optimize based on ChatGPT\'s real-time citation patterns. Our approach delivers measurable ChatGPT visibility and consistent brand mentions.',
  },
  {
    id: 'growth',
    icon: <Rocket className="w-8 h-8 text-purple-600" />,
    title: 'ChatGPT Authority Building',
    description:
      'Establish your brand as ChatGPT\'s trusted authority through strategic content depth and digital credibility optimization. We create ChatGPT-preferred content formats including detailed how-to guides, concrete examples, comparison tables, and expert analysis that ChatGPT consistently cites across diverse user queries.',
  },
]

const ChatGPTSEOPitch: React.FC = () => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-3xl lg:text-6xl font-sans text-gray-700 mb-4 bungee-inline-regular">
              The Best ChatGPT SEO Agency for {' '}<br/>
              <span className="bg-blue-600 bg-clip-text text-transparent ">
                 AI Visibility
              </span>
            </h2>
            <p className="text-base md:text-2xl text-blue-400 font-semibold">
              Helping Businesses Get Cited in ChatGPT Search
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              <p className="text-lg sm:text-lg lg:text-xl text-gray-700 leading-relaxed">
                Traditional <a className='text-blue-600 underline hover:text-blue-900 transition-colors' href="https://www.vaphers.com/international-seo-services">international seo services</a> won't cut it for ChatGPT dominance. ChatGPT delivers comprehensive conversational answers that require deep, authoritative content optimized for its unique citation algorithms. Our ChatGPT SEO strategies ensure your brand becomes the go-to source ChatGPT consistently quotes and recommends.
              </p>
              <p className="text-lg sm:text-lg lg:text-xl text-gray-700 leading-relaxed">
                Our comprehensive ChatGPT SEO combines advanced Generative Engine Optimization (GEO), structured data markup, conversational query optimization, and ChatGPT-specific content architecture. From Q&A format mastery to citation-optimized how-to guides, we position your business as the authoritative source ChatGPT trusts and consistently references in user conversations.
              </p>
              <div className="mt-4 pb-4 flex justify-center sm:justify-start">
                <div className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-full shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
                  <span className="mr-3">Get ChatGPT SEO Audit</span>
            ...
            <div className="space-y-8">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg min-h-[280px]">
                {/* Gradient Border */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#70a597] via-emerald-500 to-teal-500 rounded-2xl p-[3px] pointer-events-none">
...
export default ChatGPTSEOPitch
