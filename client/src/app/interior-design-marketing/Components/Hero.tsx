    ...
    <div className="relative mx-auto mb-10 flex max-w-full flex-col items-center justify-center bg-gradient-to-b from-blue-900 via-blue-800 to-blue-600 lg:-mt-28 lg:pt-40 lg:pb-20 lg:mx-3 lg:rounded-4xl">
      ...
      <div className="px-4 pb-10">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-200 md:text-4xl lg:text-7xl dark:text-slate-300 bungee-inline-regular">
          {isMobile ? (
            "Interior Design Marketing That Drives Real Clients Across The US & UK"
          ) : (
            "Interior Design Marketing That Drives Real Clients Across The US & UK"
              .split(" ")
              .map((word, index) => (
                <motion.span key={index} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: index * 0.1, ease: "easeInOut" }} className="mr-2 inline-block">
                  {word}
                </motion.span>
              ))
          )}
        ...
        {isMobile ? (
          <>
            <p className="relative z-10 mx-auto max-w-xl py-4 text-center text-lg font-normal text-neutral-400 dark:text-neutral-400">
              You started a design studio to create beautiful spaces, not to wrestle with algorithms. Our tailored marketing for interior design firms and custom interior design marketing strategies ensure high-value clients discover your studio before they ever find your competitor.
            </p>
            ...
            <div className="relative z-10 mt-20 rounded-3xl border border-neutral-300 bg-neutral-200 p-4 shadow-md dark:border-neutral-800 dark:bg-neutral-900">
              <div className="w-full overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700">
                <Image src="https://res.cloudinary.com/dbwrnwa3l/image/upload/v1770818890/ChatGPT_Image_Feb_11_2026_07_37_55_PM_q9spwb.png" alt="Interior design marketing preview" className="aspect-[16/9] h-auto w-full object-cover" height={1000} width={1000} sizes="(max-width: 768px) 100vw, 1000px" priority loading="eager" />
              </div>
            </div>
          </>
        ) : (
          <>
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.8 }} className="relative z-10 mx-auto max-w-3xl py-4 text-center text-lg font-normal text-neutral-400 dark:text-neutral-400">
              You started a design studio to create beautiful spaces, not to wrestle with algorithms. Our tailored marketing for interior design firms and custom interior design marketing strategies ensure high-value clients discover your studio before they ever find your competitor.
            </motion.p>
