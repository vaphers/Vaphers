  ...
  const services = [
    {
      ...
      description: "Rank higher on Google for the exact searches your dream clients are running, from 'luxury interior designer near me' to 'best commercial design firm' in your city.",
      tags: ["Organic Growth", "Long-Term ROI"],
      link: "https://www.vaphers.com/seo-services",
    },
    {
      title: "Portfolio & Visual Branding",
      description: "Showcase your design work with optimized, high-resolution project galleries that convert portfolio browsers into consultation requests.",
      tags: ["Visual Identity", "Brand Authority"],
      link: "https://www.vaphers.com/contact",
    },
    {
      title: "Local & Maps Marketing",
      description: "Dominate your regional market, enhance your Google Business Profile, and attract quality local leads straight to your studio doorstep.",
      tags: ["Local Presence", "Targeted Leads"],
      link: "https://www.vaphers.com/seo-services/local-seo-services",
    },
    {
      title: "Content & Social Strategy",
      description: "Build a content engine that positions your studio as the thought leader in your market, from blog articles to social media narratives.",
      tags: ["Thought Leadership", "Engagement"],
      link: "https://www.vaphers.com/contact",
    }
  ];
