          ...
          <div className="lg:col-span-6 w-full space-y-4 sm:space-y-6 pb-10 sm:pb-12 lg:pb-16 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="w-full">
              ...
              <h3 className="text-[28px] sm:text-3xl md:text-4xl lg:text-5xl text-gray-200 mb-3 sm:mb-4 lg:mb-6 leading-[1.2] bungee-inline-regular">
                Is SEO Worth It for a <span className="bg-blue-400 bg-clip-text text-transparent">
                  Design Studio?
                </span>
              </h3>
            ...
            If your best clients are still coming only from referrals, you're one slow season away from an empty pipeline. SEO doesn't replace your reputation, it puts it in front of more people, consistently, without you having to network for it. It's slower than paid ads, but it compounds: what you rank for today keeps bringing clients next year too.
            </p>
