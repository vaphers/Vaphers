      ...
      <div className="w-[88%] mx-auto px-6 md:px-12 pt-16 pb-12 md:pb-24">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
          <div className="w-full lg:w-[60%]">
            ...
            >
              Unlocking Organic Growth For Top Interior Design Studios
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              We partner with visionary interior designers to build high-converting search strategies, optimize project portfolios, and attract premium clients that elevate your firm's digital footprint.
            </motion.p>
          </div>
          ...
          <div className="flex-1 flex items-end w-full">
            ...
            >
              ...
              <div className="relative z-10 p-6 md:p-8 h-full flex flex-col justify-between min-h-[200px]">
                ...
                <p className="text-sm text-blue-100 mt-8 leading-relaxed">
                  Long-term partnerships built on transparency and measurable aesthetic growth.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex-1 flex items-end w-full">
            ...
            >
              ...
              <div className="relative z-10 p-6 md:p-8 h-full flex flex-col justify-between min-h-[200px]">
                ...
                <p className="text-sm text-blue-100 mt-8 leading-relaxed">
                  Years dedicated exclusively to elevating digital marketing for creative businesses.
                </p>
              </div>
            </motion.div>
          </div>
