...
const SeoLeads: React.FC = () => {
  ...
  return (
    <section
      ref={ref}
      className="max-w-full h-screen bg-white bg-cover bg-center bg-no-repeat overflow-hidden"
      style={{
        backgroundImage:
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 sm:gap-10 lg:gap-12">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed text-center lg:text-left">
              SEO generates qualified leads by positioning your business where potential customers across the U.S. are actively searching for solutions. Studies show that 57% of B2B businesses report getting more leads from search engines than any other channel. When prospects search for what you offer, comprehensive{' '}
              <a
              ...
              identify opportunities to capture this high-intent traffic, while{' '}
              <a
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed text-center lg:text-left">
              ...
              lies in targeting every stage of the customer journey. Educational content builds trust during the awareness phase, while optimized service pages convert ready-to-buy prospects throughout American markets. Modern{' '}
              <a
