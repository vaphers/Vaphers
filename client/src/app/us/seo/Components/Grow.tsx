...
const GrowWithSEO: React.FC = () => {
  ...
  const opacity = useTransform(scrollYProgress, [0, 0.5], isMobile ? [1, 1] : [0, 1])
  ...
  return (
    <div className="w-full relative">
      ...
      <section ref={ref} className="relative z-10 max-w-full bg-transparent overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-16 sm:pb-12 lg:pb-0">
          <div className="flex flex-col lg:flex-row items-center lg:items-end gap-8 sm:gap-10 lg:gap-12">
            <motion.div style={leftStyle} className="w-full lg:w-2/3 space-y-4 sm:space-y-6">
              <div>
                <h2 className="text-4xl sm:text-3xl md:text-4xl lg:text-5xl text-center lg:text-start font-montserrat text-gray-700 mb-3 sm:mb-4 lg:mb-5 bungee-inline-regular">
                  ...
                  <span className="bg-blue-600 bg-clip-text text-transparent">SEO Services</span>
                </h2>
                <p className="text-sm sm:text-base lg:text-lg text-center lg:text-start text-blue-600 font-medium">
                  Drive more traffic, leads, and sales with proven SEO.
                </p>
              </div>

              <div className="space-y-4">
                <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed text-center lg:text-left">
                  SEO turns your website into a consistent lead engine, bringing customers to you every day without relying on expensive ads. Our{' '}
                  <a
                  ...
                  help you rank in your area, while our{' '}
                  <a
                ...
                <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed text-center lg:text-left">
                  Every optimized page and backlink keeps working for you long-term, building authority, improving rankings, and generating steady growth. If you want{' '}
                  <span className="font-semibold">affordable SEO services for small business</span>, this is the smartest way to scale.
                </p>
              </div>
            ...
            <motion.div style={rightStyle} className="w-full lg:w-1/2 flex justify-center relative">
              <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg overflow-hidden">
                ...
                <div className="absolute inset-0">
                  <motion.div
                    animate={mounted && !isMobile ? { x: [0, 10, 0], y: [0, 10, 0] } : {}}
                    transition={
                      mounted && !isMobile
