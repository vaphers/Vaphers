        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-3xl md:text-3xl lg:text-6xl font-sans text-gray-700 mb-4 bungee-inline-regular">
              ...
              <span className="bg-blue-600 bg-clip-text text-transparent">Ai Visibility</span>
            </h1>
            <p className="text-base md:text-2xl text-blue-600 font-semibold">
              Helping Businesses Dominate Large Language Model AI Search in the United States
            </p>
          </div>
            ...
            <div className="group relative rounded-[2rem] p-5 text-gray-700 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden border border-pink-600 bg-white">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="text-sm font-semibold text-gray-600 leading-tight">
                  AI Referral Traffic
                  <br />
                  <span className="text-xs opacity-80">(Q1-Q2 2025)</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              <p className="text-lg sm:text-lg lg:text-xl text-gray-700 leading-relaxed">
                Generative AI has fundamentally transformed how users discover content online. With AI-powered search
                engines like ChatGPT, Gemini, and Perplexity delivering instant answers without clicks, traditional SEO
                strategies alone won't keep your business visible. AI SEO services optimize your content for citations
                in AI-generated responses, ensuring your brand dominates the new era of search.
              </p>
              <p className="text-lg sm:text-lg lg:text-xl text-gray-700 leading-relaxed">
                Our{' '}
                <a
                ...
                >
                  Affordable AI SEO services
                </a>{' '}
                combine technical optimization, strategic content structuring, and real-time performance tracking to
                maximize your visibility across all major AI platforms. From conversational query optimization to schema
                markup implementation, we use data-driven strategies that position your business as the authoritative
                source AI engines trust and recommend.
              </p>
