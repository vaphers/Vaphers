        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-end gap-8 sm:gap-10 lg:gap-12">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left">
              As a trusted SEO company for U.S based businesses, we help businesses expand their search presence across borders without unnecessary complexity. 
              Through proven SEO services, localized keyword strategies, and region-specific optimization, we ensure your brand ranks in competitive global markets. 
