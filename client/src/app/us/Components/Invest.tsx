    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-20 pb-8 sm:pb-12 lg:pb-16">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 sm:gap-10 lg:gap-12">
          {/* Content */}
          <motion.div style={{ opacity }} className="w-full lg:w-2/3 space-y-8 sm:space-y-10">
            {/* Section 1 */}
            <div>
              <h3 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl text-center lg:text-start font-montserrat text-gray-700 mb-3 sm:mb-4 bungee-inline-regular break-words">
                What
                <span className="bg-blue-600 bg-clip-text text-transparent"> Vaphers</span> Can Do for You?
              </h3>

              <p className="text-sm sm:text-base lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left break-words">
                Vaphers helps businesses across the united states build a strong and reliable digital foundation that
                supports long-term growth. From improving website structure and performance to aligning strategy with
                real user intent, we focus on solutions that drive visibility, engagement, and consistent results. Every
                recommendation is guided by data, experience, and a clear understanding of what your business needs to
                scale online.
              </p>
            </div>
            ...
            <div>
              <h4 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-center lg:text-start font-montserrat text-gray-700 mb-3 sm:mb-4 bungee-inline-regular break-words">
                What
                <span className="bg-blue-600 bg-clip-text text-transparent"> Marketing </span>
                Can Do for You?
              </h4>

              <p className="text-sm sm:text-base lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left break-words">
                Effective marketing builds visibility, credibility, and demand over time. Instead of relying on
                short-term tactics, a well-executed marketing strategy attracts the right audience, builds trust, and
                turns interest into action. The result is sustainable traffic, qualified leads, and steady business
                growth that continues to deliver value long after the initial investment.
              </p>
            </div>
