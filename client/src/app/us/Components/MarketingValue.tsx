    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-16 sm:pb-12 lg:pb-0">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 sm:gap-10 lg:gap-12">
          {/* Content */}
          <motion.div style={{ x: xLeft, opacity }} className="w-full lg:w-2/3 space-y-6 sm:space-y-8">
            {/* Section 1 */}
            <div>
              <h3 className="text-3xl md:text-3xl lg:text-5xl text-center lg:text-start font-sans text-gray-700 mb-4 bungee-inline-regular break-words">
                We Design
                <span className="bg-blue-600 bg-clip-text text-transparent"> Conversion-Driven Websites</span>
              </h3>

              <p className="text-sm sm:text-base lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left break-words">
                At Vaphers, we’re an <span className="font-medium">affordable web design agency</span> focused on
                building websites that turn traffic into real outcomes for your business in united states. Every
                layout, interaction, and user journey is designed with performance in mind, so your website supports
                growth from day one. As a trusted{' '}
                <a
                ...
                , we build fast, scalable, and SEO-optimized websites that deliver an exceptional user experience and
                long-term value.
              </p>
            </div>
            ...
            <div>
              <h4 className="text-2xl md:text-2xl lg:text-4xl text-center lg:text-start font-sans text-gray-700 mb-4 bungee-inline-regular break-words">
                What Web Design
                <span className="bg-blue-600 bg-clip-text text-transparent"> Can Do for Your Business</span>
              </h4>

              <p className="text-sm sm:text-base lg:text-xl text-gray-700 leading-relaxed text-center lg:text-left break-words">
                Strategic web design builds brand credibility, improves usability, and supports lead generation across
                every digital touchpoint. When paired with{' '}
                <a
                ...
                like conversion-optimized landing pages and clear calls to action, your website becomes a scalable sales
                engine. The result: stronger engagement, higher-quality leads, and measurable growth driven by design
                that performs.
              </p>
            </div>
          ...
          {/* Images */}
          <motion.div style={{ x: xRight, opacity }} className="w-full lg:w-1/2 flex justify-center relative">
